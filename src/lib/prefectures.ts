...
export const PREFECTURE_CODES = PREFECTURES.map((pref) => pref.code);

export function isPrefCode(value: string): boolean {
  return PREFECTURES.some((pref) => pref.code === value);
}
